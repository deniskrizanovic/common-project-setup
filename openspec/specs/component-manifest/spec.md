...
Defines a single hand-edited YAML manifest as the source of truth for the scaffold's desired components, the committed artifacts generated from it, and the drift guard that keeps them in sync.
