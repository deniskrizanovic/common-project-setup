# spec-change-branch-isolation Specification

## Purpose

Ensure OpenSpec propose and apply sessions in the project-local `spec-driven` schema clone run on a dedicated non-trunk branch, keeping change work isolated from `main`/`master`.
