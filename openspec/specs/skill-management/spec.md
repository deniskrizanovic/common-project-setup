...
Defines how the scaffold reconciles a desired github-sourced skill wishlist against the project's `skills-lock.json` and installs via the `npx skills` CLI.
